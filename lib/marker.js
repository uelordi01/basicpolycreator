...
{
  /*for(i=0;i<renderObject.renderList.length;i++)
  {
    this.renderList.drawShape()
  }*/
}
...
Shape.prototype.addMarker=function(x,y,index)
{
	var marker=new Marker(x,y);
...
Shape.prototype.addNewSelectedMarker=function(x,y)
{
	var i=0;
	var face0=-1;
	var face1=-1;
