...
MarkerHandler.prototype.addMarker=function(x,y)
{
	var marker=new Marker(x,y);
	this.markerList.push(marker);
}
MarkerHandler.prototype.addMarker=function(x,y,index)
{
	var marker=new Marker(x,y);
	this.markerList.splice(index,0,marker);
}
MarkerHandler.prototype.deleteMarker=function(index)
{
	if(index!=-1)
	{
...
MarkerHandler.prototype.findMarker=function(x,y)
{
 var i=0;
 var index=-1;
 var offsetX;
...
MarkerHandler.prototype.addNewSelectedMarker=function(x,y)
{
	var i=0;
	var face0=-1;
	var face1=-1;
	...
	this.addMarker(x,y,face0);
}
MarkerHandler.prototype.setMarkerPos=function(index,x,y)
{
	this.markerList[index].setX(x);
	this.markerList[index].setY(y);
}
MarkerHandler.prototype.setSelected=function(index)
{
	var i=0;
	for(i=0;i<this.markerList.length;i++)
	{
...
MarkerHandler.prototype.getSelectedIndex=function()
{
	return this.selectedIndex;
}
MarkerHandler.prototype.getList=function()
{
...
function makeLineVector(marker0,marker1)
{
	...
	var vax=marker0.getY()-marker1.getY();
	var vay=marker1.getX()-marker0.getX();
